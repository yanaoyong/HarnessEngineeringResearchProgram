...
- `EXP-C05-01`：`EXPLORATORY` · `OBSERVATION_ONLY` · `T03 · Medium Change` · Contract → Source → Behavior Architecture Trace。
...
- Outcome / Result：均尚未运行；`EXP-C05-01` 执行后记录 Observation Outcome，Experiment Result 为 `NOT APPLICABLE · OBSERVATION ONLY`；`EXP-C05-02..04` 才填写 Hypothesis Result
